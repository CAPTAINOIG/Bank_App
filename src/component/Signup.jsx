...
const Signup = () => {
    ...
    return (
        ...
        <div id='sign' className="col-lg-5 bg-light shadow px-3 mx-auto">
                ...
                <form action="" onSubmit={formik.handleSubmit}>
                    ...
                    <button type='submit' className='btn btn-dark w-100 text-light fs-5 fw-bold rounded my-3'>Submit</button>
                    </form>
                    </div> <br /><br /><br /><br /><br />
                    </div>
